...
class SwinUNETR(nn.Module):
    ...
    def __init__(
        ...
        in_channels: int,
        out_channels: int,
        depths: Sequence[int] = (2, 2, 2, 2), # for 3T 
#         depths: Sequence[int] = (2, 2, 2, 2, 2), # for 7T
        num_heads: Sequence[int] = (4, 8, 16, 32), # for 3T
#         num_heads: Sequence[int] = (4, 8, 16, 32, 64), # for 7T
        feature_size: int = 24,
